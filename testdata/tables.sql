...
CREATE TABLE IF NOT EXISTS `%s`.`ad_user` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record last updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`mp_m_qualification` (
  ...
  `active` TINYINT(1) NOT NULL DEFAULT '1' COMMENT 'Soft delete',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`mp_qualification` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Last updated date and time',
...
CREATE TABLE IF NOT EXISTS `%s`.`organisation` (
  ...
  `active` TINYINT NOT NULL DEFAULT 1 COMMENT 'Soft delete',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Last updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`cm_email_template` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record updated at',
