...
CREATE TABLE IF NOT EXISTS `%s`.`ad_user` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Record last updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`ad_user_permission` (
  ...
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record last updated',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `%s`.`mp_m_qualification` (
  ...
  `active` TINYINT(1) NOT NULL DEFAULT '1' COMMENT 'Soft delete',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Record updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`mp_qualification` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Last updated date and time',
...
CREATE TABLE IF NOT EXISTS `%s`.`organisation` (
  ...
  `active` TINYINT NOT NULL DEFAULT 1 COMMENT 'Soft delete',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Last updated',
...
CREATE TABLE IF NOT EXISTS `%s`.`fn_invoice_payment` (
  ...
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record last updated at.',
...
CREATE TABLE IF NOT EXISTS `%s`.`ol_module` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Record last updated',
  `published_at` TIMESTAMP NOT NULL COMMENT 'Date and time the module was marked as complete.',
...
CREATE TABLE IF NOT EXISTS `%s`.`ol_m_module` (
  ...
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record last updated, also reflects the completion date and time if the module is complete.',
  `slides_completed_at` TIMESTAMP NOT NULL COMMENT 'The date and time the module questions were completed.',
  `module_completed_at` TIMESTAMP NOT NULL COMMENT 'The date and time the entire module was completed including feedback step. This is the flag that closes the module off from further editing.',
...
CREATE TABLE IF NOT EXISTS `%s`.`ol_resource` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Record last updated',
  `presented_on` DATE NOT NULL DEFAULT '0000-00-00' COMMENT 'Optional date that specifies when the resource item was presented, published or any other relevant date attribute.',
...
CREATE TABLE IF NOT EXISTS `%s`.`cm_email_template` (
  ...
  `updated_at` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Record updated at',
...
CREATE TABLE IF NOT EXISTS `%s`.`cm_email` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created.',
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record last updated.',
  `broadcast_at` TIMESTAMP NOT NULL COMMENT 'The date the email is scheduled, or was scheduled to be broadcast - i.e. can be future or past date. Cron jobs use this date to decide if they need to process emails for this blast.',
...
CREATE TABLE IF NOT EXISTS `%s`.`wf_issue_category` (
  ...
  `active` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT 'Soft delete.',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created at',
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Rrecord last updated.',
...
CREATE TABLE IF NOT EXISTS `%s`.`ol_m_category` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record updated',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `%s`.`fn_tax` (
  ...
  `active` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Soft delete.',
  `created_at` TIMESTAMP NOT NULL DEFAULT NOW() COMMENT 'Record created',
  `updated_at` TIMESTAMP NOT NULL COMMENT 'Record last updated.',
